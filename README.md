# ⚽ GoalZone — Premier League API & UI Projesi | Bootcamp Case #5
...
* **API Geliştirme ve Tüketme:** Veritabanı operasyonlarını yürüten bir REST API yazmak ve bunu MVC tarafında `HttpClient` ile asenkron olarak tüketmek.
